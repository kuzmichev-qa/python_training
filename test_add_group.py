...
class TestAddGroup(unittest.TestCase):
    ...
    def init_group_creation(self, wd):
        ...
        wd.find_element_by_name("group_name").send_keys("group_name_1")
        wd.find_element_by_xpath("//form[@action='/addressbook/group.php']").click()
        wd.find_element_by_name("group_header").clear()
        wd.find_element_by_name("group_header").send_keys("Group_header_1")
        wd.find_element_by_xpath("//div[@id='content']/form/label[2]").click()
        wd.find_element_by_name("group_footer").clear()
        wd.find_element_by_name("group_footer").send_keys("Group_footer_1")
